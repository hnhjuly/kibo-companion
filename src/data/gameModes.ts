...
export const DID_YOU_KNOW: DidYouKnow[] = [
  ...
  { id: 'dyk-004', icon: '🎨', category: 'Creativity', fact: 'Midjourney generated over 1 billion images in its first year of public access.', kiboReaction: "That's more images than humans made in all of history before cameras! 🖼️", cardColor: ['#ff8c42', '#ffb070'], lessonLink: 'm6-l2' },
