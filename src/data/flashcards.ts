...
export const FLASHCARD_DATA: Flashcard[] = [
  ...
  { id: 'fc-m3-002', term: 'Image Generation AI', definition: 'AI that creates brand new images from text prompts. Tools include Nano Banana (Google), DALL-E (OpenAI), Adobe Firefly, and Stable Diffusion.', icon: '🖼️', module: 'AI Tools', moduleColor: '#9b6dff', moduleBg: 'rgba(155,109,255,0.15)', lessonId: 'm3-l1', difficulty: 1 },
